...
public class WiFiServiceDiscoveryActivity extends Activity implements
    ...
    public boolean handleMessage(Message msg) {
        switch (msg.what) {
            case MESSAGE_READ:
                ...
                Toast toast = Toast.makeText(context, readMessage, duration);
                toast.show();

                /*LayoutInflater factory = getLayoutInflater();
                View regisText = factory.inflate(R.layout.fragment_chat, null);
                _edittext1 = (EditText) regisText.findViewById(R.id.editText1);
                _edittext1.setText("readMessage");*/
                
                WiFiChatFragment._edittext1.setText(readMessage);
                WiFiChatFragment.clickToSend(WiFiChatFragment._edittext1);
                break;
    ...
    public void onConnectionInfoAvailable(WifiP2pInfo p2pInfo) {
        ...
        // je change chatFragment par MotusActivity (appel intent)
        getFragmentManager().beginTransaction()
